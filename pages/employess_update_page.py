...
class UpdateEmployeesPage:
    def __init__(self, page: ft.Page):
        ...
        # Элементы интерфейса
        self.text_add = ft.Text(f"Обновление данных сотрудника", color=defaultFontColor,
    ...
    def submit_form(self, e):
        ...
        if not full_name or not position or not company:
            ...
            try:
                ...
                empl = update_employee(employee_id=employee_id, full_name=full_name, position=position,
                                       com_name=company)
