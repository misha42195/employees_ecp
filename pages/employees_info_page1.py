...
#                     on_click=lambda e: self.delete_employee() # при нажатии сработает метод удаления сотрудника
#                 ),
#                 ft.CupertinoDialogAction(
#                     text="Нет",
#                     is_default_action=True,
#                     on_click=lambda e: self.del_empl(e)) # todo метод перезапускает метод отображения /employees_info
#                 # а должен просто обновить метод с инфо о сотруднике и оставить там там же
#             ],
#
#         )
#     def del_empl(self,e):
...
#         self.delete_employee_dialog.open = False
#         self.page.go("/employees_info")
#         # todo def showdetailed_employee_info
#         self.page.update()
#
#
...
#
#             self.delete_employee_dialog.open = False
#             self.dashboard_page.load_employees()
#             self.page.go("/")
#
#         except Exception as ex:
#             self.result_text.value = f"Ошибка при удалении: {str(ex)}"
